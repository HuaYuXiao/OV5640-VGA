...
The frequency divider is generated by IP core, with input 100 MHz and output 24 MHz(for camera), 25 MHz(for VGA) and 50 MHz.
...
In this project, I2C serves as a transmition method to configure registers of OV5640.
