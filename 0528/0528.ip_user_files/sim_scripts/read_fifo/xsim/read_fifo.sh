...
#
# Generated by Vivado on Sun May 28 15:17:13 +0800 2023
...
# Script info
echo -e "read_fifo.sh - Script generated by export_simulation (Vivado v2022.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L fifo_generator_v13_2_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot read_fifo xil_defaultlib.read_fifo xil_defaultlib.glbl -log elaborate.log
}
