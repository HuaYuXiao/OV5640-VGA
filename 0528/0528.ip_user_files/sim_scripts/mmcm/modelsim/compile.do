...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../ipstatic" "+incdir+../../../../cam2hdmi.gen/sources_1/ip/mmcm" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../ipstatic" "+incdir+../../../../cam2hdmi.gen/sources_1/ip/mmcm" \
