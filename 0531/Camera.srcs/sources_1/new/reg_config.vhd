...
entity reg_config is
    port (
        clk_25M : in std_logic;                 -- 25MHzÊ±ÖÓÊäÈë
        camera_rstn : in std_logic;             -- Ïà»ú¸´Î»ĞÅºÅÊäÈë
        initial_en : in std_logic;              -- ³õÊ¼»¯Ê¹ÄÜĞÅºÅÊäÈë
        reg_conf_done : out std_logic;          -- ¼Ä´æÆ÷ÅäÖÃÍê³ÉĞÅºÅÊä³ö
        i2c_sclk : out std_logic;               -- I2C´®ĞĞÊ±ÖÓÊä³ö
        i2c_sdat : inout std_logic;             -- I2C´®ĞĞÊı¾İÊäÈë/Êä³ö
        clock_20k : inout std_logic;              -- 20kHzÊ±ÖÓÊä³ö
        reg_conf_done_reg : inout std_logic       -- ¼Ä´æÆ÷ÅäÖÃÍê³ÉµÄ¼Ä´æÆ÷Êä³ö
    );
...
begin
    ...
    begin
        if camera_rstn = '0' then
            ...
            if clock_20k_cnt < "010011100001" then
                clock_20k_cnt <= std_logic_vector(unsigned(clock_20k_cnt) + 1);
            else
